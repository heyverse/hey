...
const MediaFilter = () => {
  ...
  return (
    <Menu as="div" className="relative">
      ...
      <MenuTransition>
        <MenuItems
          className="absolute right-0 z-[5] mt-1 rounded-xl border border-gray-200 bg-white py-1 shadow-xs focus:outline-hidden dark:border-gray-700 dark:bg-gray-900"
          static
        >
          <MenuItem
            as="label"
